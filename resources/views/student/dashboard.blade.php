                    ...
                    <div class="card-body">
                        <div class="scholarship-grid">
                            ...
                            <div class="scholarship-card" data-scholarship="presidents">
                                ...
                                <p class="scholarship-description">For students with exceptional academic performance.
                                </p>
                            ...
                            <div class="scholarship-card" data-scholarship="private">
                                ...
                                <p class="scholarship-description">External scholarships from private organizations.
                                </p>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group ched-strand-field" style="display: none;">
                                        ...
                                        <select id="ched_strand" name="strand">
                                            ...
                                            <option value="STEM">STEM (Science, Technology, Engineering, Mathematics)
                                            </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="disability-field-container">
                                        <select id="disability" name="disability" class="disability-select">
                                            ...
                                            <option value="Disability due to Chronic Illness">Disability due to Chronic
                                                Illness</option>
                                        ...
                                        <div class="disability-info">
                                            ...
                                            <span>Spell out. Possible values <strong>(Communication Disability,
                                                    Disability due to Chronic Illness, Learning Disability, Intellectual
                                                    Disability, Orthopedic Disability, Mental/Psychological Disability,
                                                    Visual Disability)</strong> [Leave blank if not applicable]</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <select id="presidents_department" name="department" required>
                                        ...
                                        <option value="SITE">School of Information Technology and Engineering (SITE)
                                        </option>
                                        <option value="SASTE">School of Arts, Sciences and Teacher Education (SASTE)
                                        </option>
                            ...
                            <div class="form-row">
                                <div class="form-group full-width">
                                    ...
                                    <div class="file-upload-container">
                                        <input type="file" id="inst_document_upload" name="documents[]" multiple
                        ...
                        <form action="{{ route('scholarship.submit') }}" method="POST"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="other_scholarship" name="other_scholarship" rows="3"
                                        placeholder="Please provide additional details about the scholarship"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="private_contact_number" name="contact_number" required
                                        maxlength="11" placeholder="09123456789">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <textarea id="private_address" name="address" rows="3"
                                        placeholder="House No., Street, Barangay, City/Municipality, Province"></textarea>
                                </div>
                            </div>
